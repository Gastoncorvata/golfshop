...
const sumar = (contador)=>{
    ...
    return (
        <>
            <h2 className="animate-pulse font-light italic text-2xl text-center text-teal-600"> {count}  Unidades</h2>
            <div className="grid w-full justify-items-center mt-24">
            <div className="flex p-1 w-1/2">
                <div className="flex-none w-1/2 relative">
                    <img src={item?.img} className="absolute inset-0 w-full object-cover" alt="item imagen"/>
                </div>
